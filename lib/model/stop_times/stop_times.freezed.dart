...
mixin _$StopTimes {
  ...
  int get dropOffType => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      stopSequence: null == stopSequence
          ...
          : stopSequence // ignore: cast_nullable_to_non_nullable
              as int,
      stopHeadsign: null == stopHeadsign
          ? _value.stopHeadsign
          : stopHeadsign // ignore: cast_nullable_to_non_nullable
              as String,
      pickupType: null == pickupType
          ? _value.pickupType
          : pickupType // ignore: cast_nullable_to_non_nullable
              as int,
      dropOffType: null == dropOffType
          ? _value.dropOffType
          : dropOffType // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
...
/// @nodoc
@JsonSerializable()
class _$_StopTimes implements _StopTimes {
  const _$_StopTimes(
      {this.id = '',
      this.tripId = '',
      this.arrivalTime = '',
...
abstract class _StopTimes implements StopTimes {
  const factory _StopTimes(
      ...
      final String stopHeadsign,
      final int pickupType,
      final int dropOffType}) = _$_StopTimes;
